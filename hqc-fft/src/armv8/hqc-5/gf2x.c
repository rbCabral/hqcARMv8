...
void karat_mult_5(uint64_t *Out, uint64_t *A, uint64_t *B) {
    ...
    karat_mult_square_64(D3, a3, b3);
    karat_mult_square_64(D4, a4, b4);

    karat_mult_square_64(D01, aa01, bb01);
    karat_mult_square_64(D02, aa02, bb02);
    karat_mult_square_64(D03, aa03, bb03);
    karat_mult_square_64(D04, aa04, bb04);

    karat_mult_square_64(D12, aa12, bb12);
    karat_mult_square_64(D13, aa13, bb13);
    karat_mult_square_64(D14, aa14, bb14);

    karat_mult_square_64(D23, aa23, bb23);
    karat_mult_square_64(D24, aa24, bb24);

    karat_mult_square_64(D34, aa34, bb34);
