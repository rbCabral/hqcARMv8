...
void test_polymul_17920(void)
{
    unsigned len_u64 = 280;
...
void test_polymul_36864(void)
{
    unsigned len_u64 = 576;
...
void benchmark_polymul( unsigned len_u64 )
{
    ...
    uint64_t bm_mul[TEST_NUM]; int len_m[1] = {0};
    uint64_t bm_inp[TEST_NUM]; int len_i[1] = {0};
